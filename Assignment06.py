...
# HOrikasa,11/22/2021,Modified code to complete assignment 06
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def add_data_to_list(task, priority, list_of_rows):
        """ Adds data to a list of into dictionary rows

        :param task: (string) name of task
        :param priority: (string) name of priority
        :return: (list) of dictionary rows
        """
    ...
    def remove_data_from_list(task, list_of_rows):
        ...
        :param task: (string) name of task
        :param list_of_rows: (list) of dictionary rows of data
        :return: (list) of dictionary rows
        """
...
class IO:
    ...
    def input_new_task_and_priority():
        """ Gets new task and priority values to be added to list
    ...
    def input_task_to_remove():
        """ Gets task name to be removed from list
...
while (True):
    ...
    if choice_str.strip() == '1':  # Add a new Task
        ...
        table_lst = Processor.add_data_to_list(task, priority, table_lst)
        continue  # to show the menu

    elif choice_str == '2':  # Remove an existing Task
        task = IO.input_task_to_remove()
        table_lst = Processor.remove_data_from_list(task, table_lst)
        continue  # to show the menu
